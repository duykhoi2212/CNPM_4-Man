  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (data && typeof data === 'object') {
        ...
        setError(firstMessage || 'Dang ky that bai.');
      } else {
  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-4rem-136px)] bg-gray-100 px-4 py-12">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8">
        <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Dang ky tai khoan</h2>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700">Ho</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Dia chi</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Xac nhan mat khau</label>
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          Da co tai khoan?{' '}
          <Link to="/login" className="font-medium text-primary hover:text-teal-600">Dang nhap</Link>
        </p>
      </div>
    </div>
  );
